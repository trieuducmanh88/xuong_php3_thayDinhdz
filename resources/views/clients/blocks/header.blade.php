                        ...
                        <div class="col-lg-6 text-right">
                            <div class="header-top-settings">
                                <ul class="nav align-items-center justify-content-end">
                                    ...
                                    <li class="language">
                                        <img src="{{asset ('assets/client/img/icon/en.png')}}" alt="flag"> VietNamese
                                        <i class="fa fa-angle-down"></i>
                                        <ul class="dropdown-list">
                                            <li><a href="#"><img src="{{asset ('assets/client/img/icon/en.png')}}" alt="flag"> english</a></li>
                                            <li><a href="#"><img src="{{asset ('assets/client/img/icon/fr.png')}}" alt="flag"> vietnam</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="main-menu-area">
                                <div class="main-menu">
                                    ...
                                    <nav class="desktop-menu">
                                        <ul>
                                            <li class="active"><a href="{{route('home.clients')}}">Home <i class="fa fa-angle-down"></i></a></li>
                                            <li class="position-static"><a href="#">pages <i class="fa fa-angle-down"></i></a></li>
                                            <li><a href="shop.html">shop <i class="fa fa-angle-down"></i></a></li>
                                            <li><a href="blog-left-sidebar.html">Blog <i class="fa fa-angle-down"></i></a> </li>
