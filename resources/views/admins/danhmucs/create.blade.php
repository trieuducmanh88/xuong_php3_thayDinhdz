                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ten_danh_muc" name="ten_danh_muc" class="form-control @error('ten_danh_muc') is-invalid @enderror" value="{{old('ten_danh_muc')}}" placeholder="Nhập tên danh mục">
                                ...
                                <div class="col-sm-10 d-flex gap-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="trang_thai" id="trang_thai1" value="1" checked>
                                        <label class="form-check-label text-success" for="trang_thai1">Hiển thị</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="trang_thai" id="trang_thai2" value="0">
