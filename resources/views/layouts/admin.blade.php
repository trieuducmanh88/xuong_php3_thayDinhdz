...
<head>
        ...
        <!-- Icons -->
        <link href="{{asset('assets/admin/css/icons.min.cs')}}s" rel="stylesheet" type="text/css" />
        @yield('css')
    </head>
    ...
    <body data-menu-color="light" data-sidebar="default">
        ...
        <!-- Apexcharts JS -->
        <script src="{{asset('assets/admin/libs/apexcharts/apexcharts.min.j')}}s"></script>kgrrggrrrttrrrrrrrrrtponm
